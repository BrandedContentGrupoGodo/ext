...
function changeContent(territory, initialLoad = false) {
    ...
    case 'formacion':
        territoryInfo = {
            ...
            listItems: ['<li><img src="https://brandedcontentgrupogodo.github.io/ext/caixabank-laisla/assets/img/icon1.svg" alt="Small Image"><span>Se le conoce también como <a href="https://www.caixabankdualiza.es/" target="_blank" rel="nofollow"> CaixaBank Dualiza.</a></span></li>',
